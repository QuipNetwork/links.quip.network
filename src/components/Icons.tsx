...
export function Icon({ name, className = '', size = 20, style }: IconProps) {
  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    farcaster: (
      <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} className={className}>
        <path d="M18.24 2.4H5.76C3.936 2.4 2.4 3.936 2.4 5.76v12.48c0 1.824 1.536 3.36 3.36 3.36h12.48c1.824 0 3.36-1.536 3.36-3.36V5.76c0-1.824-1.536-3.36-3.36-3.36zm-1.2 13.92h-1.68v-4.56c0-1.584-1.296-2.88-2.88-2.88s-2.88 1.296-2.88 2.88v4.56H7.92V8.16h1.68v.96c.624-.72 1.536-1.2 2.64-1.2 1.968 0 3.6 1.632 3.6 3.6v4.8h1.2z"/>
      </svg>
    ),
    github: (
      <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} className={className}>
